...
if __name__ == "__main__":
    ...
    from scenarionet.converter.vod.utils import convert_vod_scenario, get_vod_scenarios, \
    ...
    parser.add_argument(
        "--dataset_name", "-n", default="vod", help="Dataset name, will be used to generate scenario files"
    )
    parser.add_argument(
        "--split",
        default="v1.0-mini",
    ...
    if version in scene_split:
        scenarios, vod = get_vod_scenarios(args.dataroot, version, args.num_workers)
    else:
